...
public class CityWeatherPanelService {
    ...
    public static CityWeatherPanelItemDto toPanelItem(ImdCityWeatherResponse r) {
        ...
        days.add(new CityWeatherPanelDayDto(
                1,
                "Today (" + ForecastDayLabels.today() + ")",
                blankToDash(d1Max),
                blankToDash(d1Min),
                d1Fc,
                iconTokenForForecast(r.todaysForecast())
        ));
        days.add(dayRow(2, ForecastDayLabels.fromTodayPlusDays(1), r.day2MaxTemp(), r.day2MinTemp(), r.day2Forecast()));
        days.add(dayRow(3, ForecastDayLabels.fromTodayPlusDays(2), r.day3MaxTemp(), r.day3MinTemp(), r.day3Forecast()));
        days.add(dayRow(4, ForecastDayLabels.fromTodayPlusDays(3), r.day4MaxTemp(), r.day4MinTemp(), r.day4Forecast()));
        days.add(dayRow(5, ForecastDayLabels.fromTodayPlusDays(4), r.day5MaxTemp(), r.day5MinTemp(), r.day5Forecast()));
        days.add(dayRow(6, ForecastDayLabels.fromTodayPlusDays(5), r.day6MaxTemp(), r.day6MinTemp(), r.day6Forecast()));
        days.add(dayRow(7, ForecastDayLabels.fromTodayPlusDays(6), r.day7MaxTemp(), r.day7MinTemp(), r.day7Forecast()));
